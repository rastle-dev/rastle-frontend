...
const API = {
  ...
  KAKAO_AUTH_URL: `${BASE_URL}/oauth2/authorization/kakao?redirect_uri=https://www.raste.site`,
  LOCAL_KAKAO_AUTH_URL: `${BASE_URL}/oauth2/authorization/kakao?redirect_uri=http://localhost:3000`,
  NAVER_AUTH_URL: `${BASE_URL}/oauth2/authorization/naver?redirect_uri=https://www.raste.site`,
