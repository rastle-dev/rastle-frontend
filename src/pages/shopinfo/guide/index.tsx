      ...
      <ItemContainer>
        <GuideContainer>
          ...
          <p>
            ...
            무료로 이용하실 수 있습니다. 회원가입 시 3,000원의 적립금이
            지급됩니다.
          </p>
        </GuideContainer>
        ...
        <GuideContainer>
          ...
          <p>배송 방법 : 택배</p>
          <p>배송 지역 : 전국지역</p>
          <p>배송 비용 : 기본 3,000원, 제주도 지역 6,000원</p>
          <p>배송 기간 : 3일 ~ 7일</p>
          <p>
        ...
        <GuideContainer>
          ...
          <p>
            ...
            상품 수령 후 3일이내에 "마이페이지 -&gt; 주문 상세 조회 -&gt; 반품
            {/* eslint-disable-next-line react/no-unescaped-entities */}
            신청" 이나 카카오톡 채널 "레코디 슬로우" 를 통해 교환 및 반품 접수가
            완료되어야 합니다. (반품 접수 없이 자사로 배송된 상품은 통보 없이
            반송됩니다.)
          </p>
        ...
        <GuideContainer>
          <h3>배송안내</h3>
          <p>택배사는 한진 택배를 이용하고 있습니다.</p>
          <br />
          <p>배송비는 기본 3,000원, 제주도 지역 6,000원 입니다.</p>
          <br />
