...
export default function EnterViewMoreModal() {
  return (
    <Wrapper>
      <ItemContainer>
        <h3>이용약관</h3>
        <br />
        제1조(목적)
        <br />이 약관은&nbsp;OO&nbsp;회사(전자상거래 사업자)가
        운영하는&nbsp;OO&nbsp;사이버 몰(이하&nbsp;“몰”이라 한다)에서 제공하는
        ...
        상실한 적이 있는 경우,&nbsp;다만 제7조제3항에 의한 회원자격 상실
        후&nbsp;3년이 경과한 자로서&nbsp;“몰”의 회원재가입 승낙을 얻은 경우에는
        예외로 한다.
        <br />
        ...
        <br />
        제7조(회원 탈퇴 및 자격 상실 등)
        <br />① 회원은&nbsp;“몰”에 언제든지 탈퇴를 요청할 수 있으며&nbsp;“몰”은
        즉시 회원탈퇴를 처리합니다.
        ...
        <br />
        ②&nbsp;“몰”은 불특정다수 회원에 대한 통지의
        경우&nbsp;1주일이상&nbsp;“몰”&nbsp;게시판에 게시함으로서 개별 통지에
        ...
        위탁하는 경우에는&nbsp;1)&nbsp;개인정보 취급위탁을 받는 자,
        2)&nbsp;개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를
        받아야 합니다. (동의를 받은 사항이 변경되는 경우에도
        ...
        손해배상을 청구하지 않습니다.&nbsp;다만 재화 등의 내용이 표시·광고
        ...
        사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할
        수 있습니다.
        ...
        경우,&nbsp;상당한 기간 이내에&nbsp;“몰”에 대하여 회원정보 수정 등의
        ...
        대금,&nbsp;기타&nbsp;“몰”이용에 관련하여 회원이 부담하는 채무를 기일에
        지급하지 않는 경우
        <br />
        ...
        이용목적,&nbsp;제3자에 대한 정보제공 관련사항(제공받은자,&nbsp;제공목적
        및 제공할 정보의 내용)&nbsp;등 「정보통신망 이용촉진 및 정보보호 등에
        관한 법률」 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며
        ...
        연결“몰”의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그
        ...
        지적재산권은&nbsp;”몰“에 귀속합니다.
        <br />
        &nbsp; ②&nbsp;이용자는&nbsp;“몰”을 이용함으로써 얻은 정보
        중&nbsp;“몰”에게 지적재산권이 귀속된 정보를&nbsp;“몰”의 사전 승낙 없이
        복제,&nbsp;송신,&nbsp;출판,&nbsp;배포,&nbsp;방송 기타 방법에 의하여
        영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.
        <br />
